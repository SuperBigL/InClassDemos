...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="row col-md-12">
        <asp:Repeater ID="MenuCategories" runat="server" DataSourceID="ODSCategoryMenuItems">
            <ItemTemplate>
                <h3>  <img src='<%# "../Images/" + Eval("Description") + "-1.png" %>' width="80" height="80" /> <%# Eval("Description") %>  </h3>  
    ...
    <asp:ObjectDataSource ID="ODSCategoryMenuItems" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetCategoryMenuItems_List" TypeName="eRestaurantSystem.BLL.AdminController"></asp:ObjectDataSource>
