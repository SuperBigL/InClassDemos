...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <br />
    <asp:ObjectDataSource ID="ODSSSpecialEvents" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SpecialEventsList" TypeName="eRestaurantSystem.BLL.AdminController"></asp:ObjectDataSource>
